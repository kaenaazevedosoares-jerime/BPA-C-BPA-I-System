...
const ProcedureForm: React.FC<ProcedureFormProps> = ({ onCancel, onSave, initialId }) => {
  ...
  const isLocked = siaProcessed && userProfile?.role?.toLowerCase() !== 'admin';

  const isStatusLocked = isLocked || (userProfile?.role?.toLowerCase() !== 'admin' && (
    (status === 'Finalizado') ||
    (status === 'Cancelado')
  )); // Only Admins can revert Finalized/Cancelled status or edit SIA processed items
    ...
    <div className="max-w-xl mx-auto p-4 pb-24 space-y-6 animate-fade-in">
      {isLoading ? (
        ...
        <>
          ...
          {isLocked && (
            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 p-4 rounded-xl flex items-center gap-3 animate-fade-in mb-4">
              <span className="material-symbols-outlined text-amber-500">lock</span>
              <p className="text-xs font-bold text-amber-700 dark:text-amber-300">
                Este procedimento foi processado no SIA. Apenas administradores podem fazer alterações.
              </p>
            </div>
          )}
          ...
          <div className="bg-surface-light dark:bg-surface-dark border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm space-y-6">
            ...
            <div className={`group relative ${showResults ? 'z-50' : 'z-20'}`}>
              ...
              <div className="relative">
                ...
                <input
                  className={`w-full bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl py-3.5 pl-12 pr-4 focus:border-primary focus:ring-1 focus:ring-primary transition-all text-sm ${isSearching ? 'animate-pulse' : ''} disabled:opacity-50 disabled:cursor-not-allowed`}
            ...
            <div className={`group relative ${showProcResults ? 'z-50' : 'z-10'}`}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl py-3.5 pl-12 pr-4 focus:border-primary focus:ring-1 focus:ring-primary transition-all text-sm font-mono ${isProcSearching ? 'animate-pulse' : ''} disabled:opacity-50 disabled:cursor-not-allowed`}
              ...
              <div className="space-y-6 animate-fade-in">
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <input
                        ...
                        disabled={isLocked}
                        className="w-full bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl py-3.5 px-4 pr-12 focus:border-primary focus:ring-1 focus:ring-primary transition-all text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                      />
                      <button
                        type="button"
                        onClick={() => {
                    ...
                    <div className="group animate-fade-in">
                      ...
                      <div className="relative">
                        <input
                          ...
                          disabled={isLocked}
                          className="w-full bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800 text-red-900 dark:text-red-200 rounded-xl py-3.5 px-4 pr-12 focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-all text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        />
                        <button
                          type="button"
                          onClick={() => {
                ...
                <div className="group">
                  ...
                  <textarea
                    ...
                    disabled={isLocked}
                    className="w-full bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white rounded-xl py-4 px-4 focus:border-primary focus:ring-1 focus:ring-primary transition-all text-sm min-h-[120px] resize-none disabled:opacity-50 disabled:cursor-not-allowed"
